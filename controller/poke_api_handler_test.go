...
func TestGetPokemonFromPokeApiSuccess(t *testing.T) {
	...
	body, err := ioutil.ReadFile("examples/poke_api_read.json")
	c.NoError(err)
...
func TestGetPokemonFromPokeApiSuccessWithMocks(t *testing.T) {
	...
	body, err := ioutil.ReadFile("examples/poke_api_response.json")
	c.NoError(err)
...
func TestGetPokemon(t *testing.T) {
	...
	expectedBody, err := ioutil.ReadFile("examples/api_response.json")
	c.NoError(err)
	...
	c.Equal(expected, actualPokemon)
}
